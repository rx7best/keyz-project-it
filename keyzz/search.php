...
if (isset($_POST['box_id'])) {
    ...
    $box_id = isset($_SESSION['box_id']) ? $_SESSION['box_id'] : null;
}
...
<div class="flex justify-center  flex-wrap mx-3 mt-5 ">
       ...
       <?php 
            ...
            echo $box_id;
            $apartment = find_boxname($box_id);
            echo "อพาร์ตเมนท์ ".$apartment ."<br>"; 
            echo "ตู้ที่ ".$box_id;
    ...
    if (mysqli_num_rows($result2) > 0) {
        while($row = mysqli_fetch_assoc($result2)) {
            ...
            if (!empty($row["room_number"])) {
                ...
                echo "<div class='bg-[#EFEFEF] w-full text-black py-11 px-4 rounded transition'>ไม่มีเลขห้อง</div>";
            }
        }
        echo "</div>";
    } else {
