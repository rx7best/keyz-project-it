        ...
        <form class="row gy-4 w-full w-72 bg-white border border-stone-500 rounded-lg" action="upReservation.php" method="POST">
            ...
            <div class="flex justify-center mx-3 mb-6 mt-5">
                ...
                <div class="w-full md:w-1/2 px-3">
                    ...
                    <input type="text" class="appearance-none block w-full bg-[#ffeb3b] text-gray-700 border border-stone-950 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white" id="line_id" name="line_id" placeholder="Line ID" value="<?php echo $row['line_id'] ?>" required>
                </div>

                <div class="w-full md:w-1/2 px-3">
                    <label for="note" class="form-label">โน๊ต</label>
                    <input type="text" class="appearance-none block w-full bg-[#ffeb3b] text-gray-700 border border-stone-950 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white" id="note" name="note" placeholder="โน๊ต" value="<?php echo $row['note'] ?>" required>
                </div>        
            </div> 
